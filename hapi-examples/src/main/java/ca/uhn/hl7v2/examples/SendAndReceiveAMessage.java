...
public class SendAndReceiveAMessage {
   ...
   public static void main(String[] args) throws Exception {
      ...
      server.registerApplication("ADT", "A03", handler);
      server.registerApplication("ADT", "A04", handler);
      server.registerApplication("ADT", "A05", handler);
      server.registerApplication("ADT", "A06", handler);
      server.registerApplication("VXX", "V02", handler);
      server.registerApplication("ADT", "A07", handler);
      server.registerApplication("ORU", "R01", handler);
      server.registerApplication("ORU", "R30", handler);
      server.registerApplication("ORU", "R31", handler);
      server.registerApplication("ORU", "R32", handler);
